...
export function ActionsCard({
  ...
  return (
    <aside className="w-full lg:w-[28%] lg:shrink-0 lg:overflow-hidden">
      <div className="rounded-xl border p-4 lg:h-full lg:flex lg:flex-col lg:justify-between" style={{ borderColor: BORDER, background: SURFACE }}>
        ...
        <div>
          ...
          {/* Coverage stat — bordered top + bottom */}
          <div
            className="mt-3 pt-3 pb-3 border-t border-b flex items-center justify-between text-[10.5px]"
